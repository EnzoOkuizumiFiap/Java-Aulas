        ...
        do {
            try {
                ...
                do {
                    ...
                    if (!sigla.equals("FIM")) {
                        if (mapa.containsKey(sigla)) { //containsKey -> contém a chave
                ...
                if (mapa.containsKey(escolha)) { //containsKey já tem uma estrutura de repetição dentro dele, percorre o HashMap do começo ao fim
