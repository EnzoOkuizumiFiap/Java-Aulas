...
public class Exemplo2 {
    public static void main(String[] args) {
        try {
            ...
            if (num1 < 1 || num1 > 50) { //Regra de negócio
        ...
        } catch (NumberFormatException e) { //Excecão para o parseInt
            JOptionPane.showMessageDialog(null, "Erro de formato numérico: " + e.getMessage());
        } catch (HeadlessException e) { //Exceção para o showInputDialog
            JOptionPane.showMessageDialog(null, "Erro de leitura via caixa de diálogo: " + e.getMessage());
        } catch (ArithmeticException e) { //Exceção para Divisão por zero
