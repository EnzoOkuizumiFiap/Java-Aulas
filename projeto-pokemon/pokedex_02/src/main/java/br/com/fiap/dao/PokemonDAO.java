...
public class PokemonDAO {
    public ArrayList<PokemonTO> findAll() {
        ...
        pokemon = new PokemonTO(1L, "Charizard", 9.21, 95.5, "Fogo", LocalDate.parse("2025-10-09"));
        pokemons.add(pokemon);
        pokemon = new PokemonTO(1L, "Bulbasaur", 0.70, 6.9, "Planta", LocalDate.parse("2023-10-01"));
        pokemons.add(pokemon);
